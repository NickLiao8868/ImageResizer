...
namespace ImageResizer
{
    public class ImageProcess
    {
        ...
        public async Task ResizeImagesAsync(string sourcePath, string destPath, double scale)
        {
            ...
            {
                tasks.Add(
                    Task.Run(async () => await ResizeImagesAsync(destPath, scale, filePath))
                );
            }
            await Task.WhenAll(tasks);
        }

        private async Task ResizeImagesAsync(string destPath, double scale, string filePath)
        {
            ...
            Bitmap bitmap = await processBitmap((Bitmap)imgPhoto,
